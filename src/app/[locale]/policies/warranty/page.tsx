...
export const metadata = { title: "Warranty Policy — Nivro" };
  ...
  return (
    <PolicyLayout title="Warranty Policy" lastUpdated="29 May 2026">
      <p>
        ...
        paid Additional Warranty options apply to products purchased through www.nivro.co.uk.
      </p>
      ...
      <p>5.2 Manufacturer warranty terms are set by the manufacturer, not by Nivro.</p>
      <p>
      ...
      <p>
        5.5 Nivro may assist with manufacturer warranty claims where reasonable, but we do not control
      ...
      <p>6.1 Nivro may offer paid Additional Warranty options for selected products.</p>
      ...
      <p>11.1 To make a warranty claim, contact us at info@nivro.co.uk.</p>
      ...
      <p>
        12.1 Warranty claims may require inspection by Nivro, the manufacturer, supplier, service
      ...
      <p>
        ...
        may be covered by Nivro where required by law or approved by us.
      </p>
      <p>
      ...
      <p>
        17.4 To the fullest extent permitted by law, Nivro will not be liable to Business Customers for
