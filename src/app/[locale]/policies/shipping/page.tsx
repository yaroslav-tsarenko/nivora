...
export const metadata = { title: "Shipping Policy — Nivro" };

export default function ShippingPolicyPage() {
  return (
    <PolicyLayout title="Shipping Policy" lastUpdated="29 May 2026">
      <p>
        This Shipping Policy explains how orders placed through www.nivro.co.uk are processed,
      ...
      <p>
        ...
        means EDGEBRAY LIMITED. &ldquo;Customer&rdquo;, &ldquo;you&rdquo; or &ldquo;your&rdquo; means the
      ...
      <p>1.1 This Policy applies to the delivery of physical goods purchased through Nivro.</p>
      <p>
        1.2 Nivro supplies electrical products, electrical materials, wiring accessories,
      ...
      <p>3.1 Nivro dispatches orders from the United Kingdom.</p>
      <p>
      ...
      <p>
        5.4 Nivro is not responsible for delays caused by customs authorities, local postal operators,
      ...
      <p>
        7.3 Nivro is not responsible for delays, failed deliveries, lost parcels, return charges, or
      ...
      <p>
        8.1 Nivro may accept international orders to supported delivery destinations shown on the
      ...
      <p>
        9.3 Nivro does not control customs authorities, import tax assessments, duty rates, customs
      ...
      <p>
        12.4 Nivro is not responsible for failed delivery where you do not respond to courier notices, do
      ...
      <p>
        ...
        extended period, please contact us at info@nivro.co.uk.
      </p>
      <p>
      ...
      <p>
        16.2 Nivro is not responsible for loss, damage, delay, customs issues, onward shipping problems,
      ...
      <p>
        17.3 Nivro is not responsible for labour costs, electrician costs, contractor costs, installation
