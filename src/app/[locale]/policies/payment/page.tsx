...
export const metadata = { title: "Payment Policy — Nivro" };
  ...
  return (
    <PolicyLayout title="Payment Policy" lastUpdated="29 May 2026">
      <p>
        ...
        for purchases made through www.nivro.co.uk.
      </p>
      <p>The Website is operated by:</p>
      <ContactBlock />
      <p>
        In this Policy, &ldquo;Nivro&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo; or &ldquo;our&rdquo;
        means EDGEBRAY LIMITED. &ldquo;Customer&rdquo;, &ldquo;you&rdquo; or &ldquo;your&rdquo; means any
      ...
      <p>
        1.2 Nivro sells electrical products, electrical materials, wiring accessories, lighting-related
      ...
      <p>
        2.5 Nivro does not control exchange rates, bank conversion fees, card issuer charges, or foreign
        transaction fees.
      </p>
      ...
      <p>
        3.4 Price changes will not affect orders already accepted by Nivro, except where there has been
      ...
      <p>4.1 Nivro accepts secure card payments using:</p>
      <ul>
        <li>Visa</li>
        <li>Mastercard</li>
      </ul>
      ...
      <p>
        5.3 Nivro does not guarantee that your payment will be accepted. Payment approval depends on
      ...
      <p>6.1 Nivro takes payment security seriously.</p>
      <p>
        6.2 Card payments are handled through secure third-party payment providers. Nivro does not store
      ...
      <p>
        8.2 Nivro is not responsible for payment failures caused by your bank, card issuer, payment
      ...
      <p>
        9.1 To protect customers, Nivro, payment providers, and card networks, transactions may be
      ...
      <p>
        10.3 Where applicable, Nivro may issue order confirmations, payment confirmations, receipts, VAT
      ...
      <p>12.1 Nivro dispatches orders from the United Kingdom.</p>
      <p>
      ...
      <p>
        ...
        in the product price, delivery price, or payment collected by Nivro.
      </p>
      <p>
      ...
      <p>
        12.5 Nivro does not control customs authorities, customs delays, import tax assessments, courier
      ...
      <p>
        ...
        is required by law or approved by Nivro, the related Additional Warranty charge may also be
        refunded.
      </p>
      ...
      <p>
        ...
        are not controlled by Nivro and are not refundable by Nivro.
      </p>
      <p>
        15.6 Customs duties, import VAT, local taxes, brokerage fees, courier handling fees, customs
        clearance fees, and other local charges are not charged by Nivro and are not refundable by
        Nivro.
      </p>
      ...
      <p>
        ...
        should contact us first at info@nivro.co.uk so we can investigate and try to resolve the issue.
      </p>
      <p>
      ...
      <p>
        17.2 Nivro does not offer credit terms, open account purchasing, or deferred payment to Business
