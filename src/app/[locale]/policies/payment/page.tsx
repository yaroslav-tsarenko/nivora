...
export const metadata = { title: "Payment Policy — Electreia" };
  ...
  return (
    <PolicyLayout title="Payment Policy" lastUpdated="29 May 2026">
      <p>
        ...
        for purchases made through www.electreia.co.uk.
      </p>
      <p>The Website is operated by:</p>
      <ContactBlock />
      <p>
        In this Policy, &ldquo;Electreia&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo; or &ldquo;our&rdquo;
        means LORDCARE LIMITED. &ldquo;Customer&rdquo;, &ldquo;you&rdquo; or &ldquo;your&rdquo; means any
      ...
      <p>
        1.2 Electreia sells electrical products, electrical materials, wiring accessories, lighting-related
      ...
      <p>
        2.5 Electreia does not control exchange rates, bank conversion fees, card issuer charges, or foreign
        transaction fees.
      </p>
      ...
      <p>
        3.4 Price changes will not affect orders already accepted by Electreia, except where there has been
      ...
      <p>4.1 Electreia accepts secure card payments using:</p>
      <ul>
        <li>Visa</li>
        <li>Mastercard</li>
      </ul>
      ...
      <p>
        5.3 Electreia does not guarantee that your payment will be accepted. Payment approval depends on
      ...
      <p>6.1 Electreia takes payment security seriously.</p>
      <p>
        6.2 Card payments are handled through secure third-party payment providers. Electreia does not store
      ...
      <p>
        8.2 Electreia is not responsible for payment failures caused by your bank, card issuer, payment
      ...
      <p>
        9.1 To protect customers, Electreia, payment providers, and card networks, transactions may be
      ...
      <p>
        10.3 Where applicable, Electreia may issue order confirmations, payment confirmations, receipts, VAT
      ...
      <p>12.1 Electreia dispatches orders from the United Kingdom.</p>
      <p>
      ...
      <p>
        ...
        in the product price, delivery price, or payment collected by Electreia.
      </p>
      <p>
      ...
      <p>
        12.5 Electreia does not control customs authorities, customs delays, import tax assessments, courier
      ...
      <p>
        ...
        is required by law or approved by Electreia, the related Additional Warranty charge may also be
        refunded.
      </p>
      ...
      <p>
        ...
        are not controlled by Electreia and are not refundable by Electreia.
      </p>
      <p>
        15.6 Customs duties, import VAT, local taxes, brokerage fees, courier handling fees, customs
        clearance fees, and other local charges are not charged by Electreia and are not refundable by
        Electreia.
      </p>
      ...
      <p>
        ...
        should contact us first at info@electreia.co.uk so we can investigate and try to resolve the issue.
      </p>
      <p>
      ...
      <p>
        17.2 Electreia does not offer credit terms, open account purchasing, or deferred payment to Business
