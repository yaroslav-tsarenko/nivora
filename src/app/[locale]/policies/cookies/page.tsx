...
export const metadata = { title: "Cookie Policy — Electreia" };

export default function CookiePolicyPage() {
  return (
    <PolicyLayout title="Cookie Policy" lastUpdated="29 May 2026">
      <p>
        This Cookie Policy explains how LORDCARE LIMITED, trading as Electreia, uses cookies and similar
        technologies on www.electreia.co.uk.
      </p>
      <p>The Website is operated by:</p>
      <ContactBlock />
      <p>
        In this Cookie Policy, &ldquo;Electreia&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo; or
        &ldquo;our&rdquo; means LORDCARE LIMITED. &ldquo;You&rdquo; or &ldquo;your&rdquo; means any visitor,
      ...
      <ul>
        <li>first-party cookies, set directly by Electreia; or</li>
      ...
      <p>
        8.2 These cookies may be set by Electreia or by third-party advertising and marketing partners.
      </p>
      <p>
      ...
      <p>9.4 Electreia does not store your full card number or full card security code.</p>
